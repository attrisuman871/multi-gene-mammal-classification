...
5.All intermediate files are generated by running the notebook. No processed data is stored in this repository.

6. If you already have intermediate files (e.g., aligned FASTAs), you can skip earlier sections and start from any point in the pipeline.
